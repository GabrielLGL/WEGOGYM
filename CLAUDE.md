...
- **Schema:** v39 (`mobile/src/model/schema.ts`).
- **Models:**
...
- **IA — offline only** : Les cloud providers (Gemini, Claude, OpenAI) ont été retirés. L'app utilise exclusivement le moteur offline (`offlineEngine.ts` + `programGenerator/`). Ne pas réintroduire de providers cloud.
...
- **FontSize**: `fontSize.caption` (11), `fontSize.xs` (12), `fontSize.sm` (14), `fontSize.bodyMd` (15), `fontSize.md` (16), `fontSize.lg` (18), `fontSize.xl` (20), `fontSize.xxl` (24), `fontSize.xxxl` (28), `fontSize.title` (26), `fontSize.jumbo` (48)
