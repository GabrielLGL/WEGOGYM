export const fr = {
  ...
  settings: {
    ...
    appearance: {
      ...
      unitsDescription: 'Kilogrammes ou livres',
      metric: 'Métrique (kg)',
    ...
    timer: {
      ...
      durationError: 'Durée invalide (10-600 secondes)',
    ...
    gamification: {
      ...
      streakDanger: {
        ...
        body: 'Plus que quelques jours pour garder ton streak cette semaine !',
        settingLabel: 'Alerte streak',
        settingDescription: 'Notification si ton streak est en danger',
      },
    },
    ai: {
  ...
  home: {
    ...
    sleep: {
      title: 'Sommeil',
      quality: { excellent: 'Excellent', good: 'Bon', fair: 'Moyen', poor: 'Insuffisant' },
      deep: 'Profond',
      light: 'Léger',
      rem: 'Paradoxal',
      awake: 'Éveillé',
  ...
  exercises: {
    ...
    favorites: 'Favoris',
    catalogBannerTitle: 'Explore 800+ exercices',
    catalogBannerSubtitle: 'Importe depuis le catalogue global',
    otherSection: 'Autre',
    duplicateTitle: 'Exercice similaire',
    duplicateMessage: 'Un exercice similaire existe déjà :',
  ...
  accessibility: {
    ...
    repsInput: 'Nombre de répétitions',
    validateSet: 'Valider la série',
    unvalidateSet: 'Annuler la série',
    ...
    workoutTimer: 'Temps écoulé',
    totalVolume: 'Volume total',
    completedSets: 'Séries complétées',
    workoutSummary: 'Résumé de la séance',
  ...
  toasts: {
    ...
    programDuplicated: 'Programme dupliqué',
    programDeleted: 'Programme supprimé',
    exerciseCreated: 'Exercice créé',
    exerciseDeleted: 'Exercice supprimé',
    exerciseUpdated: 'Exercice modifié',
    exerciseImported: 'Exercice importé',
    exerciseAdded: 'Exercice ajouté',
    exerciseRemoved: 'Exercice retiré',
