...
export const en: typeof fr = {
  ...
  settings: {
    ...
    appearance: {
      ...
      units: 'Weight units',
      unitsDescription: 'Kilograms or pounds',
      metric: 'Metric (kg)',
    ...
    timer: {
      ...
      durationError: 'Invalid duration (10-600 seconds)',
    ...
    gamification: {
      ...
      streakDanger: {
        ...
        body: 'Only a few days left to keep your streak this week!',
        settingLabel: 'Streak alert',
        settingDescription: 'Notification when your streak is at risk',
      },
    },
    ai: {
  ...
  exercises: {
    ...
    favorites: 'Favorites',
    catalogBannerTitle: 'Explore 800+ exercises',
    catalogBannerSubtitle: 'Import from the global catalog',
    otherSection: 'Other',
    duplicateTitle: 'Similar exercise',
    duplicateMessage: 'A similar exercise already exists:',
  ...
  emptyStates: {
    programsTitle: 'No programs',
    programsMessage: 'Create your first program to organize your workouts.',
    programsCta: 'Create a program',
    photosTitle: 'No photos',
    photosMessage: 'Take photos to track your transformation.',
    photosCta: 'Add a photo',
    leaguesTitle: 'No ranking yet',
    leaguesMessage: 'Complete at least 2 weeks of training to unlock the ranking.',
    chartsTitle: 'No data',
    chartsMessage: 'Select an exercise to see your progression.',
    collectionTitle: 'Empty collection',
    collectionMessage: 'Add exercises to start your collection.',
  },
  ...
  accessibility: {
    ...
    darkMode: 'Dark mode',
    language: 'Language',
    toggleExpand: 'Tap to expand or collapse',
    ...
    goal: 'Training goal',
    streak: 'Streak and heatmap',
    weeklyActivity: 'Weekly activity',
    bodyStatus: 'Body status',
    dayWorked: 'Day worked',
    dayRest: 'Rest day',
    reminders: 'Training reminders',
    weightInput: 'Weight in kilograms',
    repsInput: 'Number of repetitions',
    validateSet: 'Validate set',
    unvalidateSet: 'Undo set',
    exerciseInSuperset: 'Exercise in superset',
    exerciseInCircuit: 'Exercise in circuit',
    restTimer: 'Rest timer',
    skipTimer: 'Skip timer',
    workoutTimer: 'Elapsed time',
    totalVolume: 'Total volume',
    completedSets: 'Completed sets',
    workoutSummary: 'Workout summary',
    filterBy: 'Filter by',
    allFilters: 'All',
    searchExercises: 'Search for an exercise',
  ...
  toasts: {
    ...
    exerciseImported: 'Exercise imported',
