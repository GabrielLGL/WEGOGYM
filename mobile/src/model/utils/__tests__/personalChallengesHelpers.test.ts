...
describe('computePersonalChallenges', () => {
  ...
  it('chaque challenge a une progression entre 0 et 1', () => {
    const user = makeUser({ totalTonnage: 100000, totalPrs: 50, bestStreak: 10, level: 20 })
  ...
  it('marque completed quand progression >= 1', () => {
    const user = makeUser({ totalTonnage: 2000000, totalPrs: 600, bestStreak: 30, level: 60 })
  ...
  it('trie non-complétés en premier par progression décroissante', () => {
    const user = makeUser({ totalTonnage: 40000, totalPrs: 20, bestStreak: 3, level: 10 })
  ...
  it('les challenges complétés sont après les non-complétés', () => {
    const user = makeUser({ totalTonnage: 100000, totalPrs: 30, bestStreak: 5, level: 55 })
